...
- **Luciphilus hero:** adventurer / escort / monster-clearer. Current roster is Swordsman L1-L9, Female Mage Level 1-9, Male Mage Level 1-9, and the actual Priest sprite route. Female Mage Levels 1-3 use Mage4 and Levels 4-9 use Mage3; Female Mage Level 2 adds one spark, Female Mage Level 3 adds the same twin sparks later kept by Level 4, and Male Mage keeps the previous early ladder. Level 8 is the dragon-eye glyph, and Level 9 keeps the final grand magic aura. Priest uses the actual Priest sprite with a finalized Luciphilus healer overlay ladder: healing mote, twin motes, healer cross, remedy vial, healing staff, mending hands, life chalice, two holy grails, and a winged holy grail.
